...
const ENTRY = {
  ...
  day: '월',
  category: 'UX 개선',
  work: '홈 대시보드 건의함 알림 배너 — 역할 분기. 관리자(대표): lastReplyBy=user(새 문의·사용자 답글) N건 로즈/앰버 배너. 사용자(어머니): lastReplyBy=admin(내 문의 답변 도착) 보라/블루 배너. 같은 자리에서 역할에 따라 색·문구·아이콘 분기, 클릭 시 /feedback. 인사말 아래 배치.',
  commit: '(이번 세션)',
  note: '어머니=답변 도착 알림, 대표=답변 필요 알림. 양방향 건의함 인지.',
};
